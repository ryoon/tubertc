...
var attrDialogTmpl = Handlebars.compile(
    ...
    '  <img style="width: 176px; height: 203px;" src="' + window.location.pathname + 'images/about_tubertc.svg" alt="[about]">' +
    '</div>' +
    '<ul>' +
    ...
    '<li>Screen icon made by Creative Stall, PK from <a href="https://thenounproject.com/">Noun Project</a> is licensed under <a href="http://creativecommons.org/licenses/by/3.0/" title="Creative Commons BY 3.0">CC BY 3.0</a></li>' +
